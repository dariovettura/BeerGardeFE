...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot='switch'
      className={cn(
        'peer data-[state=checked]:bg-green-700 data-[state=unchecked]:bg-red-700 focus-visible:border-ring focus-visible:ring-ring/50 dark:data-[state=checked]:bg-green-800 dark:data-[state=unchecked]:bg-red-800 inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    >
