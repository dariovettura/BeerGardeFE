...
import { DataTableServerSkeleton } from './data-table-server-skeleton'
      ...
      <div className='relative flex flex-1'>
        <div className='absolute inset-0 flex overflow-hidden rounded-lg border'>
          <ScrollArea className='h-full w-full'>
            <Suspense
              fallback={
                <DataTableServerSkeleton
                  columnCount={skeletonProps?.columnCount || columnCount}
